...
const tuiHeroNewClosingLine = "→ Prefer filling title, objective, and scope in Config (alt+7). You may also edit .workflow-hero/cycles/current/workflow-config.yml. Then run /hero-start to start the new cycle."
