...
- **2026-08-26 — Chat composer and harness wait UX**: Chat Enter/Alt+Enter bindings were inverted (newline/send), vertical caret movement now follows the composer’s visual wrapping, ordinary new turns clear stale status results, and the harness watchdog ignores expected permission/question pauses.
