...
1. C09 Telegram plugin: Planning must create the OpenSpec SDD for the optional local daemon, shared ConversationService extraction, IPC, vault pairing, queue, logs, and release/install path.
