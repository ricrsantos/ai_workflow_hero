...
| **Phase** | Hero **1.1.0** minor release; **C3 archived** (2026-08-09). No active cycle. |
...
- Chat is first in the TUI tab bar (`alt+1`); boot still Status. Chat header shows a live agents box; transcript labels parent vs Task subagents (2026-08-14).
